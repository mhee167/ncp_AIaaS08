    ...
    .then((result) => {
      ...
      if (student.photo) {
        document.querySelector(
          "#f-photo-origin"
        ).href = `https://kr.object.ncloudstorage.com/ncp08-bucket-116677-member-photo/${student.photo}`;
        document.querySelector(
          "#f-photo"
        ).src = `https://wcaggdnm4774.edge.naverncp.com/diYOJZ4LYN/board/jang.webp?type=f&w=80&h=80&faceopt=true&ttype=jpg/${student.photo}?type=f&w=80&h=80&faceopt=true&ttype=jpg`;
      } /*else {
